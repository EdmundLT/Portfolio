const Tos = () => {
  return (
    <div className="mx-auto text-white space-y-2 p-4">
      ...
      <p className="text-3xl text-center py-2">Interpretation and Definitions</p>
      <p className="text-2xl">Interpretation</p>
      <p>
      ...
      <p className="text-2xl">Definitions</p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to EdmundLT Tech.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to EdmundLT Tech, accessible from{" "}
            <a
              href="https://www.edmundlt.tech/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.edmundlt.tech/
            </a>
          </p>
        </li>
        <li>
      ...
      <p className="text-3xl text-center py-2">Acknowledgment</p>
      <p>
      ...
      <p className="text-3xl text-center py-2">Links to Other Websites</p>
      <p>
      ...
      <p className="text-3xl text-center py-2">Termination</p>
      <p>
      ...
      <p className="text-3xl text-center py-2">Limitation of Liability</p>
      <p>
      ...
      <p className="text-3xl text-center py-2">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</p>
      <p>
      ...
      <p className="text-3xl text-center py-2">Governing Law</p>
      <p>
      ...
      <p className="text-3xl text-center py-2">Disputes Resolution</p>
      <p>
      ...
      <p className="text-3xl text-center py-2">For European Union (EU) Users</p>
      <p>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which you are resident
        in.
      </p>
      <p className="text-3xl text-center py-2">United States Legal Compliance</p>
      <p>
      ...
      <p className="text-3xl text-center py-2">Severability and Waiver</p>
      <p className="text-2xl">Severability</p>
      <p>
      ...
      <p className="text-3xl text-center py-2">Translation Interpretation</p>
      <p>
      ...
      <p className="text-3xl text-center py-2">Changes to These Terms and Conditions</p>
      <p>
      ...
      <p className="text-3xl text-center py-2">Contact Us</p>
      <p>
        If you have any questions about these Terms and Conditions, You can
        contact us:
      </p>
      <ul>
        <li>By email: edmundtlca@gmail.com</li>
      </ul>
    </div>
  );
};
